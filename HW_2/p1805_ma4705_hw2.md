...
``` r
zipcodes_df = read_csv("./datasets/Zip Codes.csv") |>
  janitor::clean_names() |>
...
```
    ...
    ##  1 Bronx Cou…         36 005               36005    10451 7/25/07   High Bridge…
    ##  2 Bronx Cou…         36 005               36005    10452 7/25/07   High Bridge…
    ##  3 Bronx Cou…         36 005               36005    10453 7/25/07   Central Bro…
    ##  4 Bronx Cou…         36 005               36005    10454 7/25/07   Hunts Point…
    ##  5 Bronx Cou…         36 005               36005    10455 7/25/07   Hunts Point…
    ##  6 Bronx Cou…         36 005               36005    10456 7/25/07   High Bridge…
    ##  7 Bronx Cou…         36 005               36005    10457 7/25/07   Central Bro…
    ##  8 Bronx Cou…         36 005               36005    10458 7/25/07   Bronx Park …
    ##  9 Bronx Cou…         36 005               36005    10459 7/25/07   Hunts Point…
    ## 10 Bronx Cou…         36 005               36005    10460 7/25/07   Central Bro…
    ## # ℹ 312 more rows

``` r
zori_df = read_csv("./datasets/Zip_zori_uc_sfrcondomfr_sm_month_NYC.csv") |>
  janitor::clean_names() |>
  mutate(zip_code = region_name, county = county_name) |>
  select(-region_name, -region_type, -county_name)
```
...
```
    ...
    ## # A tibble: 149 × 124
    ##    region_id size_rank state_name state city     metro   x2015_01_31 x2015_02_28
    ##        <dbl>     <dbl> <chr>      <chr> <chr>    <chr>         <dbl>       <dbl>
    ##  1     62080         4 NY         NY    New York New Yo…         NA          NA 
    ##  2     62093         7 NY         NY    New York New Yo…         NA          NA 
    ##  3     62019         9 NY         NY    New York New Yo…         NA          NA 
    ##  4     62046        16 NY         NY    New York New Yo…         NA          NA 
    ##  5     61807        17 NY         NY    New York New Yo…         NA          NA 
    ##  6     62085        18 NY         NY    New York New Yo…         NA          NA 
    ##  7     62037        19 NY         NY    New York New Yo…       1920.       1947.
    ##  8     62018        20 NY         NY    New York New Yo…       1943.       1851.
    ##  9     61639        29 NY         NY    New York New Yo…       3055.       3053.
    ## 10     62025        32 NY         NY    New York New Yo…         NA          NA 
    ## # ℹ 139 more rows
    ## # ℹ 116 more variables: x2015_03_31 <dbl>, x2015_04_30 <dbl>,
...
``` r
zori_zip_df = left_join(zipcodes_df, zori_df, by = "zip_code")

zori_zip_df
```

    ## # A tibble: 322 × 130
    ##    county.x   state_fips county_code county_fips zip_code file_date neighborhood
    ##    <chr>           <dbl> <chr>             <dbl>    <dbl> <chr>     <chr>       
    ##  1 Bronx Cou…         36 005               36005    10451 7/25/07   High Bridge…
    ##  2 Bronx Cou…         36 005               36005    10452 7/25/07   High Bridge…
    ##  3 Bronx Cou…         36 005               36005    10453 7/25/07   Central Bro…
    ...
    ## 10 Bronx Cou…         36 005               36005    10460 7/25/07   Central Bro…
    ## # ℹ 312 more rows
    ## # ℹ 123 more variables: region_id <dbl>, size_rank <dbl>, state_name <chr>,
    ## #   state <chr>, city <chr>, metro <chr>, x2015_01_31 <dbl>, x2015_02_28 <dbl>,
    ...
    ## #   x2016_03_31 <dbl>, x2016_04_30 <dbl>, x2016_05_31 <dbl>, …
